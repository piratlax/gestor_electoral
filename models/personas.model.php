...
static public function mdlCrearPersona($tabla, $datos){
	$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, paterno, materno, direccion, colonia, localidad, seccion, ocupacion, celular, email, telefono, persona_clave, foto, inef, inet, latitud, longitud) VALUES (:nombre, :paterno, :materno, :direccion, :colonia, :localidad, :seccion, :ocupacion, :celular, :email, :telefono, :persona_clave, :foto, :inef, :inet, :latitud, :longitud)");
