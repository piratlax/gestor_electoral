...
class ModeloProblematicas{

	// mostrar solicitudes
    static public function mdlMostrarProblematicas($tabla, $item, $valor){
        if($item != null){
	...
	//crear problematica
	static public function mdlCrearProblematica($tabla, $valor){
		
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (problematica, descripcion) VALUES (:problematica, :descripcion)");

		$stmt->bindParam(":problematica", $valor["problematica"], PDO::PARAM_STR);
