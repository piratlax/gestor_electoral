   ...
   foreach ($usuarios as $key => $value){
      ...
      echo ' <tr>
              ...
              if($value["estado"] != 0){
                ...
                echo '<td><button class="btn btn-success btn-xs btnActivar" idUsuario="'.$value["persona_clave"].'" estadoUsuario="0">Activado</button></td>';

              }else{

                echo '<td><button class="btn btn-danger btn-xs btnActivar" idUsuario="'.$value["persona_clave"].'" estadoUsuario="1">Desactivado</button></td>';
              ...
              <td>
                ...
                <div class="btn-group">
                  ...
                  <button class="btn btn-info btnDetalleUsuario" idUsuario="'.$value["persona_clave"].'" data-toggle="modal" data-target="#modalDetalleUsuario"><i class="fa fa-info-circle"></i></button>

                  <button class="btn btn-danger btnEliminarUsuario" idUsuario="'.$value["persona_clave"].'" fotoUsuario="'.$value["foto"].'" usuario="'.$value["usuario"].'"><i class="fa fa-times"></i></button>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="panel"><h4>Foto Perfil</h4></div>
                <div class="col-sm-12">
            ...
            <div class="form-group">
              ...
              <div class="panel"><h4>INE FRONTAL</h4></div>
                <div class="col-sm-12">
          ...
          <div class="form-group">
              ...
              <div class="panel"><h4>INE REVERSO</h4></div>
                <div class="col-sm-12">
